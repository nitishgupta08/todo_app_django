...
deps = {
    ...
    "src/third_party/squirrel.mac/vendor/ReactiveObjC": {"url": Var("reactiveobjc_git") + "/ReactiveObjC.git@" + Var("reactiveobjc_version"), "condition": "process_deps"},
